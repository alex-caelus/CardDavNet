            ...
            get{ 
                ...
                if(encoding != null){
                    if(encoding == "quoted-printable"){
                        data = System.Text.Encoding.UTF8.GetString(Mimes.QuotedPrintableDecode(System.Text.Encoding.UTF8.GetBytes(data)));
                    }
                    else if(encoding == "b"){
                        data = System.Text.Encoding.UTF8.GetString(Net.FromBase64(System.Text.Encoding.UTF8.GetBytes(data)));
                    }
                    else{
